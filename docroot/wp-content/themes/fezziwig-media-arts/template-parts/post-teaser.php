...
if (array_intersect($category_slugs, $layout_a_categories)) {
  // Load Layout A
  get_template_part('template-parts/post-teaser--layout-a');
}
...
elseif (array_intersect($category_slugs, $layout_b_categories)) {
  // Load Layout B
  get_template_part('template-parts/post-teaser--layout-b');
} else {
  // Optionally, load a default template if needed
  get_template_part('template-parts/post-teaser--default');
}
