...
add_action('admin_menu', 'beecrafty_add_settings_boxes', 11);
function beecrafty_add_settings_boxes() {
	global $_genesis_theme_settings_pagehook;
	
	add_meta_box('genesis-theme-settings-header', __('Header Image Settings', 'beecrafty'), 'beecrafty_theme_settings_header_box', $_genesis_theme_settings_pagehook, 'column2');
}

function beecrafty_theme_settings_header_box() { ?>
...
add_filter('genesis_theme_settings_defaults', 'beecrafty_header_defaults');
function beecrafty_header_defaults($defaults) {

	$defaults['header_height'] = 180;
