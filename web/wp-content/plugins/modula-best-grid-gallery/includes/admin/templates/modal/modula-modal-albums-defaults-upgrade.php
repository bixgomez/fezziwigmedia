			...
			<div class="modula-upsells-carousel-wrapper-modal">
				<div class="modula-upsells-carousel-modal">
					<div class="modula-upsell-modal modula-upsell-item-modal">
						<h2><?php esc_html_e( 'Albums Presets', 'modula-best-grid-gallery' ); ?></h2>
						<h4 class="modula-upsell-description-modal"><?php esc_html_e( 'Speed up your albums creation process by starting from a pre-saved preset. Save any album\'s settings as a preset and reuse them indefinitely. Got a bunch of albums you want to apply a preset to? That\'s possible too with this extension.', 'modula-best-grid-gallery' ); ?></h4>
