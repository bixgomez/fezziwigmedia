<div class="modula-modal__overlay gallery-defaults">
	<div class="modula-modal__frame <?php echo esc_attr( $settings['classes'] ); ?>" 
												...
												if ( $settings['dismissible'] ) :
													?>
		data-modula-modal-dismissible data-modula-modal-id="<?php echo esc_attr( $id ); ?>"<?php endif; ?>>
			...
			<div class="modula-upsells-carousel-wrapper-modal">
				<div class="modula-upsells-carousel-modal">
					<div class="modula-upsell-modal modula-upsell-item-modal">
						<h2><?php esc_html_e( 'Gallery Presets', 'modula-best-grid-gallery' ); ?></h2>
						<h4 class="modula-upsell-description-modal"><?php esc_html_e( 'Speed up your gallery creation process by starting from a pre-saved preset. Save any gallery\'s settings as a preset and reuse them indefinitely. Got a bunch of galleries you want to apply a preset to? That\'s possible too with this extension.', 'modula-best-grid-gallery' ); ?></h4>
						<ul class="modula-upsells-list">
							<li><?php esc_html_e( 'Create gallery presets using the desired settings.', 'modula-best-grid-gallery' ); ?></li>
							<li><?php esc_html_e( 'Add a new gallery and select a preset previously created. Then add your images.', 'modula-best-grid-gallery' ); ?></li>
