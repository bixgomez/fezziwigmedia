...
(function ($, modula) {
    ...
    var modulaItemsCollection = Backbone.Collection.extend({
        ...
        initialize: function () {
            ...
            this.on('collectionUpdated', this.onCollectionUpdated, this);
            this.on('newItemAdded', this.onNewItemAdded, this);
        },
    ...
    var modulaItemView = Backbone.View.extend({
        ...
        */
        ...
        initialize: function (args) {
            ...
            this.listenTo(modula.Items, 'collectionUpdated', this.updatePosition);
        ...
        updatePosition: function () {
            var newIndex = modula.Items.indexOf(this.model);
            ...
            newIndex === 0
                ...
                : parent.children().eq(newIndex - 1).after(this.$el);

            this.model.set('index', newIndex);

            if (modula.GalleryView.container.data('packery')) {
                modula.GalleryView.container.packery('reloadItems');
                modula.GalleryView.container.packery();
            }
        },
