<div class="<?php echo esc_attr(implode(' ', $data->item_classes)); ?>" <?php echo Modula_Helper::generate_attributes($data->item_attributes); ?>>
	...
	<div class="modula-item-content">
		...
		if (modula_item_object_renders_link_overlay($data)) : ?><a<?php echo Modula_Helper::generate_attributes($data->link_attributes); ?> class="<?php echo esc_attr(implode(' ', $data->link_classes)); ?>"></a><?php endif;
