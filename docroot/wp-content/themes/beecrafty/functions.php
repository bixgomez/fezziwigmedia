...
add_image_size('Gallery', 245,245, TRUE);
...
function beecrafty_add_gallery_settings_box() {
    ...
    add_meta_box(	'genesis-theme-settings-home-gallery',
    				__('Animated Gallery Settings','beecrafty'), 
    				'beecrafty_theme_settings_home_gallery',
